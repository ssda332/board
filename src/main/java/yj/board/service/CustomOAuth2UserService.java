...
//    private final MemberRepository memberRepository;
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        System.out.println("oauth2 accessToken : " + userRequest.getAccessToken());
        ...
        // 이메일로 가입된 회원인지 조회한다.
//        Optional<Member> findMember = memberService.getUserWithAuthorities(email);
        MemberDto findMember = memberService.getUserWithAuthorities(email);
//        Optional<Member> findMember = memberRepository.findOneWithAuthoritiesByLoginId(email);
        ...
        List<SimpleGrantedAuthority> roles = findMember.getAuthorityDtoSet().stream()
